...
public class PlayerDetails {
    ...
    public Integer blocksPlaced() {
        return m_blocksPlaced;
    }

    public Integer blocksIgnited() {
        return m_blocksIgnited;
    }

    public Integer blocksDestroyed() {
        return m_blocksDestroyed;
    }

    public Integer deniedBlocksPlaced() {
        return m_deniedBlocksPlaced;
    }

    public Integer deniedBlocksDamaged() {
        return m_deniedBlocksDamaged;
    }

    public Integer deniedBlocksIgnited() {
        return m_deniedBlocksIgnited;
    }

    public Integer deniedBlocksDestroyed() {
        return m_deniedBlocksDestroyed;
    }
    ...
    public void setCantPlace(HashMap<Material, Boolean> CantPlaceList) {
        this.m_cantPlaceList = CantPlaceList;
    }

    public void setCanSpawn(HashMap<Material, Boolean> canSpawnList) {
        this.m_canSpawnList = canSpawnList;
    }
    ...
    public void incrementBlocksIgnited() {
        m_blocksIgnited++;
    }
    ...
    public void incrementDeniedBlocksPlaced() {
        m_deniedBlocksPlaced++;
    }

    public void incrementDeniedBlocksDamaged() {
        m_deniedBlocksDamaged++;
    }

    public void incrementDeniedBlocksIgnited() {
        m_deniedBlocksIgnited++;
    }

    public void incrementDeniedBlocksDestroyed() {
        m_deniedBlocksDestroyed++;
    }
    ...
    public void resetBlocksIgnited() {
        m_blocksIgnited = 0;
    }
    ...
    public void resetDeniedBlocksPlaced() {
        m_deniedBlocksPlaced = 0;
    };

    public void resetDeniedBlocksDamaged() {
        m_deniedBlocksDamaged = 0;
    }

    public void resetDeniedBlocksIgnited() {
        m_deniedBlocksIgnited = 0;
    }

    public void resetDeniedBlocksDestroyed() {
        m_deniedBlocksDestroyed = 0;
    }

    // TODO should this be can't spawn? Inclusive rather than exclusion

    public Boolean getCanSpawn(Material material) {
        return getCanSpawn(material, false);
    }
    ...
    public Boolean cantPlace(Material material) {
        return cantPlace(material, false);
    }
